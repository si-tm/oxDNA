...
# 入力ファイル名と出力ファイル名のディレクトリを同じにする
# input : results_soturon/L1/d-3-10-11-12-13/L1_d-3-10-11-12-13_0/seq_L1_d-3-10-11-12-13_0
# output : results_soturon/L1/d-3-10-11-12-13/L1_d-3-10-11-12-13_0/generated_L1_d-3-10-11-12-13_0.dat
# output : results_soturon/L1/d-3-10-11-12-13/L1_d-3-10-11-12-13_0/generated_L1_d-3-10-11-12-13_0.top
# dir_name : L1_d-3-10-11-12-13_0

# results_soturon/L3/d-384-670-1438-8/L3_d-384-670-1438-8_0/seq_L3_d-384-670-1438-8_0
...
def read_strands(filename):
    ...
    try:
        ...
        out = open (path + "/generated_" + dir_name + ".top", "w")
    except:
        print("Could not open generated_" + dir_name + ".top for writing. Aborting", file=sys.stderr)
        sys.exit(4)
    ...
    try:
        ...
        outfile = open (path + "/generated_" + dir_name + ".dat", 'w')
    except:
        print("Could not open generated_" + dir_name + ".dat for writing.  Aborting", file=sys.stderr)
        sys.exit(5)
    ...
    outfile.close()
    print("## ALL DONE. just generated 'generated_" + dir_name + ".dat' and 'generated_" + dir_name + ".top'", file=sys.stderr)
